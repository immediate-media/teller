...
import type { BriefingOutput, AnalyzeResponse } from '@/types'

type Props = {
  onResult: (briefing: BriefingOutput) => void
}
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {loading && (
          <p className="text-center text-xs text-zinc-500">
            Reading project files and generating your briefing — usually 10–20 seconds.
          </p>
        )}
      </form>
    </div>
